...
public class BackpackBlock extends Block {
    ...
    public static final VoxelShape SHAPE_N = Stream.of(
            ...
            //         VoxelShapes.combineAndSimplify(Block.makeCuboidShape(4.3, 4.2, 10, 6.3, 11.2, 11),
            //                 VoxelShapes.combineAndSimplify(Block.makeCuboidShape(4.3, 2, 6.67276, 6.3, 2.75, 11.42276),
            //                         Block.makeCuboidShape(4.3, 1, 12.2, 6.3, 4, 13.2), IBooleanFunction.OR),
            //                 IBooleanFunction.OR),
            //         IBooleanFunction.OR),
            // VoxelShapes.combineAndSimplify(Block.makeCuboidShape(9.7, 9, 8, 11.7, 10, 11),
            //         VoxelShapes.combineAndSimplify(Block.makeCuboidShape(9.7, 4.2, 10, 11.7, 11.2, 11),
            //                 VoxelShapes.combineAndSimplify(Block.makeCuboidShape(9.7, 2, 6.67276, 11.7, 2.75, 11.42276),
